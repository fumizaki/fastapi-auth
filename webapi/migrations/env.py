...
from src.infrastructure.postgresql.model.v1 import (
    AccountTable, AccountSecretTable,AuthorizationCodeTable,
    ClientApplicationTable, ClientApplicationMemberTable, ClientSecretTable
)
...
def run_migrations_online() -> None:
    ...
    config.set_section_option("alembic", "DB_PORT", str(PSQL_PORT))
